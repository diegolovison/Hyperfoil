...
public class ScenarioBuilder {
   ...
   /**
    * Returns true if the given step is the first step in an initial sequence.
    */
   public boolean isFirstStepInInitialSequence(BaseSequenceBuilder<?> sequence, StepBuilder<?> step) {
      return isInitialSequence(sequence)
